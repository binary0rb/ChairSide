...
| `src/ChairSide.Board/Services/DemoBoardStore.cs` | CSharp | types: ExceptionReasons, ReportingExceptionReasons, DemoBoardStore, BoardSnapshot, Doctor, ProcedureCategory, RoomStatus, RoomEvent<br>methods: GetSnapshot, GetRoom, IsConfiguredRoom, BeginPrestage, UpdateRoomAssignment, SeatRoom, UpdateAssignment, CancelPrestage | - |
...
| `src/ChairSide.Board/Services/ReadyHandoffPersistenceRecords.cs` | CSharp | types: ReadyHandoffTerminationKinds, PersistedRoomAssignment, PersistedReadyHandoff<br>methods: IsValid, FromCanonicalContract, FromContract, ToContract, ValidateCanonicalValues, ValidateCanonicalWrite | - |
...
| `src/ChairSide.Board/Services/SqliteBoardRepository.cs` | CSharp | types: SqliteBoardRepository, the, and, on, carries<br>methods: HasAnyRoomRows, LoadRooms, EnsureConfiguredRooms, ClearCompletedCycles, ResetActiveRooms, SaveRooms, SaveRoom, LoadCompletedCycles | - |
