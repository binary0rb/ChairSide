...
- Startup and live-board operation do not load lifetime completed history. Reporting uses windowed persistence reads and exact database counts, audit scans fixed-size persistence pages, review pages unite typed completed or aborted durable identities, and active lifecycle operations retrieve only their single durable cycle.
