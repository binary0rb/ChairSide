...
- The display stays within the selected report range and contains at most its trailing 12 intersecting calendar buckets. All Time or another open-ended range anchors to the latest dateable in-scope observation across the report population. Without one, doctor navigation remains available but the trend window is honestly empty.
